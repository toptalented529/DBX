...
const Divider = styled.div`
  background-color: ${({ theme }) => (theme.isDark ? '#1e2c37' : '#E0E1EA')};
  height: 1px;
  width: 100%;
`
...
const Footer = () => {
  ...
  return (
    <FooterContainer>
      <FooterRoot>
        <StyledLogoImg src="/images/matchaswap.png" style={{ width: '310px' }} alt="" />
        <StyledFooterDescription>
          <StyledBoldText>MatchaSwap</StyledBoldText> is a one stop solution for creating, trading and buying / selling
