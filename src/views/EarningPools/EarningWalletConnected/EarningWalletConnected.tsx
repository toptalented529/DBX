...
const EarningWalletConnected = () => {
  ...
  const [stakeColaPools] = useMemo(() => partition(pools, (pool) => pool.stakingToken.symbol === 'INV'), [pools])
  const [earnColaPools] = useMemo(() => partition(pools, (pool) => pool.earningToken.symbol === 'INV'), [pools])
