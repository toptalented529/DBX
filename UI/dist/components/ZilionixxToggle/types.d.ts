...
export declare type ZilionixxToggleTheme = {
...
export interface ZilionixxToggleProps extends InputHTMLAttributes<HTMLInputElement> {
    scale?: Scales;
    checked?: boolean;
}
...
export declare const scaleKeys: {
    readonly zilionixxSize: "zilionixxSize";
    readonly travelDistance: "travelDistance";
    readonly toggleHeight: "toggleHeight";
    readonly toggleWidth: "toggleWidth";
    readonly zilionixxThickness: "zilionixxThickness";
    readonly zilionixxTwoOffset: "zilionixxTwoOffset";
    readonly zilionixxThreeOffset: "zilionixxThreeOffset";
