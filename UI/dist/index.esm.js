...
var rotate$4 = keyframes(templateObject_1$_ || (templateObject_1$_ = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
var spinStyle$3 = css(templateObject_2$r || (templateObject_2$r = __makeTemplateObject(["\n  animation: ", " 2s linear infinite;\n"], ["\n  animation: ", " 2s linear infinite;\n"])), rotate$4);
...
var Button = function (props) {
    ...
    return (React.createElement(StyledButton$3, __assign({ "$isLoading": isLoading, className: classNames.join(" "), disabled: isDisabled }, internalProps, rest),
...
var Icon$1Q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "38", height: "38", href: "/repeat.png" })));
};

var rotate$3 = keyframes(templateObject_1$V || (templateObject_1$V = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
var spinStyle$2 = css(templateObject_2$q || (templateObject_2$q = __makeTemplateObject(["\n  animation: ", " 2s linear infinite;\n"], ["\n  animation: ", " 2s linear infinite;\n"])), rotate$3);
var ArrowSvg = styled.svg(templateObject_3$e || (templateObject_3$e = __makeTemplateObject(["\n  background: transparent;\n  border-radius: 100px;\n  align-self: center; // Safari fix\n  fill: ", ";\n  flex-shrink: 0;\n  ", "\n  ", "\n"], ["\n  background: transparent;\n  border-radius: 100px;\n  align-self: center; // Safari fix\n  fill: ", ";\n  flex-shrink: 0;\n  ", "\n  ", "\n"])), function (_a) {
    var theme = _a.theme, color = _a.color;
    return getThemeValue("colors.".concat(color), color)(theme);
}, function (_a) {
    var spin = _a.spin;
...
var Icon$1P = function (props) {
    return (React.createElement(ArrowSvg, __assign({ viewBox: "0 0 24 24" }, props),
...
var rotate$2 = keyframes(templateObject_1$U || (templateObject_1$U = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
var spinStyle$1 = css(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  animation: ", " 2s linear infinite;\n"], ["\n  animation: ", " 2s linear infinite;\n"])), rotate$2);
var CloseSvg = styled.svg(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n  width: 24px;\n  height: 24px;\n  margin: 0px 3px;\n  padding: 2px;\n  background: ", ";\n  border-radius: 100px;\n  align-self: center; // Safari fix\n  fill: #464775;\n  flex-shrink: 0;\n  ", "\n  ", "\n"], ["\n  width: 24px;\n  height: 24px;\n  margin: 0px 3px;\n  padding: 2px;\n  background: ", ";\n  border-radius: 100px;\n  align-self: center; // Safari fix\n  fill: #464775;\n  flex-shrink: 0;\n  ", "\n  ", "\n"])), function (_a) {
...
var Icon$1t = function (props) {
    return (React.createElement(CloseSvg, __assign({ color: "closeIcon", viewBox: "0 0 24 24" }, props, { style: { background: "transparent" } }),
        React.createElement(CgCloseO, { color: "white", viewBox: "0 0 24 24", size: "25px" })));
};
...
var Icon$17 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        ...
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear_zilionixxs", x1: "25.691", y1: "9.6549", x2: "25.691", y2: "40.2608", gradientUnits: "userSpaceOnUse" },
...
var Icon$15 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 70 70" }, props),
        React.createElement("circle", { cx: "45", cy: "45", r: "45", fill: "url(#paint0_linear_zilionixxround)" }),
        React.createElement("image", { href: "/logo-parsec.png", style: { alignItems: "center" } })));
};
...
var ExpandableButton = function (_a) {
    ...
    return (React.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React.createElement(Icon$1u, { color: "invertedContrast" }) : React.createElement(Icon$1x, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React.createElement(Icon$1u, { color: "primary" }) : React.createElement(Icon$1x, { color: "primary" }) }, children));
};
    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$1t, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React.createElement(Icon$1v, { color: "currentColor", width: "24px" });
...
var Container$2 = styled.div(templateObject_2$l || (templateObject_2$l = __makeTemplateObject(["\n  position: relative;\n  margin-top: 3px;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  margin-top: 3px;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var StyledWrapper = styled.div(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"], ["\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"])), function (_a) {
...
var StyledBackgroundImage = styled(Wrapper$3)(templateObject_1$A || (templateObject_1$A = __makeTemplateObject(["\n  background-repeat: no-repeat;\n  background-size: contain;\n"], ["\n  background-repeat: no-repeat;\n  background-size: contain;\n"])));
...
var TokenImage = styled(Image)(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"], ["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"])));
var templateObject_1$y;
...
var _a$3, _b$2;
var StyledPrimaryImage = styled(TokenImage)(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  position: absolute;\n  width: ", "; // 92, 82 are arbitrary numbers to fit the variant\n\n  ", "\n"], ["\n  position: absolute;\n  width: ", "; // 92, 82 are arbitrary numbers to fit the variant\n\n  ", "\n"])), function (_a) {
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$18, { color: "text", ml: "4px" })));
};
...
var ZilionixxToggle = function (_a) {
    ...
    return (React.createElement(ZilionixxStack, { scale: scale },
        React.createElement(ZilionixxInput, __assign({ id: props.id || "zilionixx-toggle", scale: scale, type: "checkbox", checked: checked }, props)),
        React.createElement(ZilionixxLabel, { scale: scale, checked: checked, htmlFor: props.id || "zilionixx-toggle" },
            React.createElement("div", { className: "zilionixxs" },
                React.createElement("div", { className: "zilionixx" }),
                React.createElement("div", { className: "zilionixx" }),
                React.createElement("div", { className: "zilionixx" }),
...
var Icon$y = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React.createElement("image", { width: "105", height: "107", href: "/diamond.png" })));
};

var Icon$x = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React.createElement("image", { href: "/diamond.png" })));
};
...
var Container$1 = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
styled(Icon$x)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
var FloatingPanIcon = styled(Icon$y)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var StepperWrapper = styled.div(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  width: fit-content;\n"], ["\n  display: flex;\n  flex-direction: column;\n  width: fit-content;\n"])));
...
var StyledStep = styled(Flex)(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  ", " {\n    justify-content: center;\n  }\n"], ["\n  ", " {\n    justify-content: center;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var StyledButton$2 = styled(IconButton)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  width: fit-content;\n  margin: 0px !important;\n"], ["\n  width: fit-content;\n  margin: 0px !important;\n"])));
var ModalCloseButton = function (_a) {
    var onDismiss = _a.onDismiss;
    return (React.createElement(StyledButton$2, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React.createElement(Icon$1t, { color: "text" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$1R, { color: "text" })));
};
var ModalContainer = styled(Box)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  overflow: hidden;\n  // background: ", ";\n  background-color: #1e2c37;\n  // box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  // border: 1px solid ", ";\n  border-radius: 10px;\n  width: 100%;\n  max-height: 100vh;\n  z-index: ", ";\n\n  ", " {\n    width: auto;\n    min-width: ", ";\n    max-width: 565px;\n  }\n"], ["\n  overflow: hidden;\n  // background: ", ";\n  background-color: #1e2c37;\n  // box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  // border: 1px solid ", ";\n  border-radius: 10px;\n  width: 100%;\n  max-height: 100vh;\n  z-index: ", ";\n\n  ", " {\n    width: auto;\n    min-width: ", ";\n    max-width: 565px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    ...
    return (React.createElement(ModalContainer, __assign({ minWidth: minWidth }, props),
        React.createElement(ModalHeader, { background: getThemeValue("colors.".concat(headerBackground), headerBackground)(theme) },
            React.createElement(ModalTitle, null,
                ...
                React.createElement(Heading, { scale: "lg" }, title)),
...
var Icon$p = function (props) {
    return (React.createElement(SwichSvg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$i = function (props) {
    return (React.createElement(Svg, __assign({ width: "27", height: "27", viewBox: "0 0 27 27", fill: "none" }, props),
...
var Icon$g = function (props) {
    return (React.createElement(Svg, __assign({ width: "24", height: "24", viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: "/trade.png", style: { alignItems: "center" } })));
};
...
var Na = styled.div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  color:#bbc0c3;  \n  font-family: ui-sans-serif;\n  font-style: normal;\n  font-size:19px;\n  font-weight: normal;\n  &:hover {\n    \n    color:white\n  \n  }\n"], ["\n  color:#bbc0c3;  \n  font-family: ui-sans-serif;\n  font-style: normal;\n  font-size:19px;\n  font-weight: normal;\n  &:hover {\n    \n    color:white\n  \n  }\n"])));
var BottomLine = styled.div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\nposition: relative;\nbottom: -7px;\nleft: -10%;\nborder: 1px solid #31b5e1;\nwidth: 120%;\n&:hover {\n  position: relative;\n  bottom: -7px;\n  left: -10%;\n  border: 1px solid #31b5e1;\n  width: 120%;\n}\n"], ["\nposition: relative;\nbottom: -7px;\nleft: -10%;\nborder: 1px solid #31b5e1;\nwidth: 120%;\n&:hover {\n  position: relative;\n  bottom: -7px;\n  left: -10%;\n  border: 1px solid #31b5e1;\n  width: 120%;\n}\n"])));
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container, { isDark: isDark, isPushed: isPushed }, links.map(function (entry) {
        var Icon = Icons[entry.icon];
        React.createElement(Icon, { width: "24px", mr: "8px" });
        entry.calloutClass ? entry.calloutClass : undefined;
        return (React.createElement(Na, { key: entry.label },
            React.createElement(Link$1, { to: entry.href }, entry.label),
            location.pathname === entry.href && React.createElement(BottomLine, null)));
    })));
};
...
var Icon$3 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { height: "100", width: "100", href: "/metamask.png" })));
};
...
var StyledButton$1 = styled(Button)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  width: 25%;\n  margin: auto;\n  // height: 155px;\n  flex-direction: column;\n  border: 0px solid ", ";\n  // border-radius: 10px;\n"], ["\n  width: 25%;\n  margin: auto;\n  // height: 155px;\n  flex-direction: column;\n  border: 0px solid ", ";\n  // border-radius: 10px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.walletButtonborder;
});
var StyledText$1 = styled(Text)(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  font-family:Poppins,system-ui;\n  font-size: 16px;\n  font-weight: 500;\n  font-stretch: normal;\n  font-style: normal;\n  line-height: normal;\n  color:white;\n"], ["\n  font-family:Poppins,system-ui;\n  font-size: 16px;\n  font-weight: 500;\n  font-stretch: normal;\n  font-style: normal;\n  line-height: normal;\n  color:white;\n"])));
var WalletCard = function (_a) {
    var login = _a.login, walletConfig = _a.walletConfig, onDismiss = _a.onDismiss, mb = _a.mb;
    var title = walletConfig.title, Icon = walletConfig.icon;
    return (React.createElement(StyledButton$1, { variant: "secondary", onClick: function () {
            login(walletConfig.connectorId);
            window.localStorage.setItem(connectorLocalStorageKey, walletConfig.connectorId);
            onDismiss();
        }, mb: mb, id: "wallet-connect-".concat(title.toLocaleLowerCase()) },
        React.createElement(Icon, { width: "53px" }),
        React.createElement(StyledText$1, { color: "text", style: { width: "150px", paddingTop: "1vw" } }, title)));
};
var templateObject_1$8, templateObject_2$4;

styled(Link)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 38px;\n  margin-bottom: 20px;\n  font-size: 18px;\n  justify-content: center;\n  color: #ee6c4d;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 38px;\n  margin-bottom: 20px;\n  font-size: 18px;\n  justify-content: center;\n  color: #ee6c4d;\n"])));
var StyledBody = styled(Flex)(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  display: flex;\n  width: 100%;\n  align-items:flex-start;\n  // flex-wrap: wrap;\n"], ["\n  display: flex;\n  width: 100%;\n  align-items:flex-start;\n  // flex-wrap: wrap;\n"])));
styled(Icon$1o)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  path {\n    fill: #ee6c4d;\n  }\n"], ["\n  path {\n    fill: #ee6c4d;\n  }\n"])));
var ConnectModal = function (_a) {
    var login = _a.login, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React.createElement(Modal, { title: " ", onDismiss: onDismiss, style: { textAlign: "center", background: "#1e2c37" } },
        React.createElement("p", { style: { fontSize: "30px", marginTop: "3vw", color: "white" } },
            "Connect to a ",
            React.createElement("span", { style: { color: "#ed3b8b" } }, "wallet")),
        React.createElement(StyledBody, { style: { padding: "3vw 0 8vw 0 " } }, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); }))));
};
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$1q, { width: "20px", color: "text", ml: "4px" }),
        React.createElement(Tooltip, { isTooltipDisplayed: isTooltipDisplayed }, "Copied")));
};
var templateObject_1$6, templateObject_2$2;

var StyledAddressBox = styled.div(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  text-align: center;\n  width: 100%;\n  border: 1px dashed ", ";\n  box-sizing: border-box;\n  border-radius: 9px;\n  padding: 13px 12px;\n  margin-bottom: 23px;\n"], ["\n  text-align: center;\n  width: 100%;\n  border: 1px dashed ", ";\n  box-sizing: border-box;\n  border-radius: 9px;\n  padding: 13px 12px;\n  margin-bottom: 23px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.modalDotted;
});
var StyledText = styled(Text)(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  color: #fff;\n  font-size: 18px;\n  line-height: 117.6%;\n"], ["\n  color: #fff;\n  font-size: 18px;\n  line-height: 117.6%;\n"])));
var StyledBold = styled.span(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  color: #ee6c4d;\n"], ["\n  color: #ee6c4d;\n"])));
var StyledButton = styled(Button)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  color: #fff;\n  font-weight: 600;\n  font-size: 20px;\n  line-height: 117.6%;\n  text-decoration-line: underline;\n  border: none !important;\n"], ["\n  color: #fff;\n  font-weight: 600;\n  font-size: 20px;\n  line-height: 117.6%;\n  text-decoration-line: underline;\n  border: none !important;\n"])));
var AccountModal = function (_a) {
    var account = _a.account, logout = _a.logout, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss, style: { background: "#1e2c37!important", color: "#fff" } },
        React.createElement(StyledAddressBox, null,
            React.createElement(StyledText, { style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, account)),
        React.createElement(Flex, { justifyContent: "space-between", mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://dbxscan.com//address/".concat(account), mr: "16px" },
                "View on \u00A0",
                React.createElement(StyledBold, null, "DBXscan")),
            React.createElement(CopyToClipboard, { toCopy: account }, "Copy Address")),
        React.createElement(Flex, { justifyContent: "center" },
            React.createElement(StyledButton, { scale: "sm", variant: "secondary", onClick: function () {
                    logout();
...
var ConnectButton = styled(Button)(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  text-shadow: none;\n  border-color: #c63458;  padding: 0px 16px;\n  border-radius: 16px;\n  border-width: 2px;\n  font-weight: 600;\n  font-size: 16px;\n  color: white;\n  height: 32px;\n  transition: background-color 0.2s, opacity 0.2s;\n  background-color:transparent;\n  &hover: {\n  background-color:white;\n\n  }\n"], ["\n  text-shadow: none;\n  border-color: #c63458;  padding: 0px 16px;\n  border-radius: 16px;\n  border-width: 2px;\n  font-weight: 600;\n  font-size: 16px;\n  color: white;\n  height: 32px;\n  transition: background-color 0.2s, opacity 0.2s;\n  background-color:transparent;\n  &hover: {\n  background-color:white;\n\n  }\n"])));
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(ConnectButton, { isDark: isDark, scale: "sm", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(ConnectButton, { isDark: isDark, scale: "sm", onClick: function () {
...
styled(Text)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  margin-right: 30px;\n  color: ", ";\n  font-weight: bold;\n"], ["\n  margin-right: 30px;\n  color: ", ";\n  font-weight: bold;\n"])), function (_a) {
    var isDark = _a.isDark;
    return (isDark ? "#EE6C4D" : "#EE6C4D");
});
var ImgDiv = styled.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\ndisplay:flex;\ngap:5px;\nalign-items:center;\n\n@media only screen and (max-width: 650px) {\n  display:none;\n}\n"], ["\ndisplay:flex;\ngap:5px;\nalign-items:center;\n\n@media only screen and (max-width: 650px) {\n  display:none;\n}\n"])));
styled.span(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  color: #fff;\n"], ["\n  color: #fff;\n"])));
styled.a(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  color: #f55b5d;\n"], ["\n  color: #f55b5d;\n"])));
styled.span(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  color: rgb(255, 178, 55);\n"], ["\n  color: rgb(255, 178, 55);\n"])));
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { isPushed: isPushed, showMenu: showMenu, isDark: isDark },
            React.createElement(ImgDiv, null,
                React.createElement("img", { width: "50px", height: "50px", src: "/circle.svg" }),
                React.createElement("img", { width: "171px", height: "27px", src: "/letter.svg" })),
            React.createElement("div", { style: { display: "flex", flexDirection: "row", justifyContent: "spaceAround" } },
                React.createElement(PanelBody, { isPushed: isPushed, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links })),
            !!login && !!logout && (React.createElement(Flex, { style: { alignItems: "center" } },
                React.createElement(UserBlock$1, { account: account, login: login, logout: logout, isDark: isDark })))),
        React.createElement(BodyWrapper, null,
            React.createElement(Inner, { isPushed: false, showMenu: false, isDark: isDark }, children),
...
export { Icon$1S as AddIcon, Alert, Icon$1R as ArrowBackIcon, Icon$1Q as ArrowDownIcon, Icon$1P as ArrowDropDownIcon, Icon$1O as ArrowDropUpIcon, Icon$1N as ArrowFirstIcon, Icon$1M as ArrowForwardIcon, Icon$1L as ArrowLastIcon, Icon$1K as ArrowUpIcon, Icon$1J as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1I as BinanceIcon, Icon$1U as BlockIcon, Icon$1H as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1G as BunnyCardsIcon, Icon$1F as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1C as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1D as CardViewIcon, Icon$1E as Cards, GridLayout as CardsLayout, Icon$1A as ChartIcon, Checkbox, Icon$1y as CheckmarkCircleFillIcon, Icon$1W as CheckmarkCircleIcon, Icon$1z as CheckmarkIcon, Icon$1x as ChevronDownIcon, Icon$1w as ChevronLeftIcon, Icon$1v as ChevronRightIcon, Icon$1u as ChevronUpIcon, Icon$1B as CircleOutlineIcon, Icon$1t as CloseIcon, Icon$1s as CogIcon, Icon$1r as CommunityIcon, ConnectorNames, Icon$1q as CopyIcon, Icon$1p as CrownIcon, Dropdown, Icon$1V as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex, Grid, Heading, Icon$1o as HelpIcon, Icon$1n as HistoryIcon, IconButton, Image, Icon$1T as InfoIcon, Input$1 as Input, Icon$1m as LanguageIcon, Icon$1l as LaurelLeftIcon, Icon$1k as LaurelRightIcon, Link, LinkExternal, Icon$1j as ListViewIcon, Icon$1i as LogoIcon, Icon$1h as LogoRoundIcon, Icon$1g as MedalBronzeIcon, Icon$1f as MedalGoldIcon, Icon$1e as MedalPurpleIcon, Icon$1d as MedalSilverIcon, Icon$1c as MedalTealIcon, Menu, Message, Icon$1b as MetamaskIcon, Icon$1a as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$19 as NoProfileAvatarIcon, NotificationDot, Icon$18 as OpenNewIcon, Overlay, Icon$16 as PencilIcon, Icon$13 as PlayCircleOutlineIcon, Icon$14 as PocketWatchIcon, Icon$Y as PresentCheckIcon, Icon$W as PresentNoneIcon, Icon$X as PresentWonIcon, Icon$12 as PrizeIcon, Progress, Icon$_ as ProgressBunny, Icon$11 as ProposalIcon, Radio, Icon$C as RefreshIcon, Icon$10 as RemoveIcon, ResetCSS, Icon$O as SearchIcon, Skeleton, Slider, Icon$N as SmallDotIcon, Spinner, Icon$M as StarFillIcon, Icon$L as StarLineIcon, Step, Stepper, StyledButton$2 as StyledButton, Svg, Icon$K as SwapVertIcon, Icon$J as SyncAltIcon, Tab, ButtonMenu as TabMenu, Tag, Icon$V as TeamPlayerIcon, Icon$U as TestnetIcon, Text, Icon$T as Ticket, Icon$S as TicketRound, Icon$R as TimerIcon, ToastContainer, Toggle, TokenImage, TokenPairImage, TooltipText, Icon$Q as TrophyGoldIcon, Icon$P as TuneIcon, Icon$$ as VerifiedIcon, Icon$I as VisibilityOff, Icon$H as VisibilityOn, Icon$G as VolumeOffIcon, Icon$F as VolumeUpIcon, Icon$E as VoteIcon, Icon$Z as WaitIcon, Icon$A as WalletFilledIcon, Icon$B as WalletIcon, Icon$D as WarningIcon, Icon$z as ZilionixxIcon, Icon$15 as ZilionixxRoundIcon, ZilionixxToggle, Icon$17 as ZilionixxsIcon, variants$4 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
