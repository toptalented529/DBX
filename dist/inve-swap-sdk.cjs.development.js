...
var IZilionixxPair = _interopDefault(require('@zilionixx/zilionixx-swap-core/build/IZilionixxSwapPair.json'));

var _SOLIDITY_TYPE_MAXIMA;

(function (ChainId) {
  ChainId[ChainId["MAINNET"] = 56] = "MAINNET";
  ChainId[ChainId["TESTNET"] = 5348] = "TESTNET";
...
var FACTORY_ADDRESS = '0x32e90b21F4ff4A43f090247CAF07eb9C87Fa50d8';
var INIT_CODE_HASH = '0x1f8f328a487f0b5937a514d6dbf9b0359ba52ae8d99ac69178218bb9db7b576d';
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'DBX', 'DBX');
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0x08BF27dD5D9E2276F16eaaf8cf2Afe5f0B7374ba', 18, 'WBNB', 'Wrapped BNB'), _WETH[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0x28137287F9Df1cfd08fb108E3a0d08624679D10c', 18, 'WBNB', 'Wrapped BNB'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'Dbx-LP', 'Dbx LPs');
...
var ZERO_HEX = '0x0';
/**
 * Represents the Zilionixx Router, and has static methods for helping execute trades.
 */
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IZilionixxPair.abi, provider).getReserves()).then(function (_ref) {
...
//# sourceMappingURL=inve-swap-sdk.cjs.development.js.map
